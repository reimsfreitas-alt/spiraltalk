...
export default function Cowboy(){
  ...
  async function toggleVoice(){
    ...
    try{
      // Open the physical microphone explicitly before starting SpeechRecognition.
      // This makes permission failures visible and avoids the silent failure path.
      ...
      r.onerror=(e:any)=>{
        const code=e?.error||'';
        if(code==='not-allowed'||code==='service-not-allowed') setError('O microfone foi bloqueado. No navegador, permita o microfone para spiraltalk.vercel.app e toque em Falar novamente.');
